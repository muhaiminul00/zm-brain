...
With Ownership, Review Triggers, Intelligence Freshness, and Confidence Decay incorporated and reconciled against the rest of the document (decay scoped to active states only, review trigger scope narrowed in Part 19), and now with a Grounding Addendum applied (Part 6, Part 13 theory-first exposition; Parts 7–10, 15 confirmed as original IP) and approved by team review, Intelligence Architecture v1.1 is frozen as of the Theoretical Grounding Phase freeze, July 2026.
